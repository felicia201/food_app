...
import './Styles/landingpage.css'; // Ajoute ce fichier CSS pour personnaliser le style
...
const LandingPage = () => {
    return (
        ...
        <
        div className = "background-image" > { /* Image de fond */ } <
        SearchBar / >
        <
        /div> { /* <SearchBar /> */ } <
        /div>
        ...
        { /* Section 3 */ } <
        div className = "section section-3" > { /* <Carousel /> */ }
        ...
        div className = "cards-container" > { /* Card 1 */ } <
        div className = "card" >
        <
        h3 > Restaurant < /h3> <
        ...
        div className = "circle-container" > { /* Ajoute ici plusieurs ronds alignés contenant des images */ } <
        /div> <
        /div> <
        Footer / >
        <
